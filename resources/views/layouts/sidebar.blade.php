        ...
        @if( Auth::user()->isParticipant())
          ...
          <ul class="sidebar-menu">
            ...
            @if(session()->has('leaderboard'))
              <li class="{{ Route::is('user.showcurrentleaderboard') ? "active" : "" }}"><a href="{{ route('user.showcurrentleaderboard', Auth::user()->id) }}"><i class="fa fa-trophy"></i> <span>LeaderBoard</span></a></li>
            @endif
